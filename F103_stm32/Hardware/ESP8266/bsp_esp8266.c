...
bool ESP8266_Net_Mode_Choose ( ENUM_Net_ModeTypeDef enumMode )
{
	...
	{
		case STA:
			return ESP8266_Cmd ( "AT+CWMODE=1", "OK", "no change", 100 ); 
...
bool ESP8266_JoinAP ( char * pSSID, char * pPassWord )
{
	...
	return ESP8266_Cmd ( cCmd, "OK", NULL, 3000 );
...
bool ESP8266_Enable_MultipleId ( FunctionalState enumEnUnvarnishTx )
{
	...
	return ESP8266_Cmd ( cStr, "OK", 0, 100 );
...
{
	if ( ! ESP8266_Cmd ( "AT+CIPMODE=1", "OK", 0, 100 ) )
		return false;
